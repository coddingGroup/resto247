    ...
    if (item.isLoading) {
        ...
        return (
                ...
                <div key={item.id} className="m-2">
                    <Card onMouseEnter={showDescription} onMouseLeave={hideDescription} className="bottom-shadow cardInWaiter" >
                        ...
                        <CardBody className="cardBodyForProductShow">
                            ...
                            <div className="">
                                <Form className="z-index-front" onSubmit={handleSubmit}>
                                    <Row>
                                        <Col md={5}>
                                            <Input onChange={changeValue} type="number" name="quantity" value={quantity} placeholder="qty:1" />
                                        </Col>
                                        <Col md={7}>
                                            <Button type="submit" size="sm" className="bottom-shadow bg-light add-to-cart-btn ">
